...
function M.get(c, opts)
    return {
        ...
        NeogitSignatureGoodUnknown    = { fg = c.good },
        NeogitSignatureGoodExpired    = { fg = c.good },
        NeogitSignatureGoodExpiredKey = { fg = c.good },
        NeogitSignatureGoodRevokedKey = { fg = c.good },
