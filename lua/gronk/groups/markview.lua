...
function M.get(c, opts)
    return {
        ...
        MarkviewHeading1 = { fg = c.struct, bg = c.attribute, bold = true },
        MarkviewHeading2Sign = { fg = c.namespace },
        MarkviewHeading2 = { fg = c.module, bg = c.namespace, bold = true },
        MarkviewHeading3Sign = { fg = c.module },
        MarkviewHeading3 = { fg = c.black, bg = c.module, bold = true },
        MarkviewHeading4Sign = { fg = c.method },
        MarkviewHeading4 = { fg = c.comment, bg = c.method, bold = true },
        MarkviewHeading5Sign = { fg = c.macro },
        MarkviewHeading5 = { fg = c.keyword, bg = c.macro, bold = true },
        MarkviewHeading6Sign = { fg = c.struct },
        MarkviewHeading6 = { fg = c.attribute, bg = c.struct, bold = true },
    }
end
