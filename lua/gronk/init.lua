...
function M.load()
    ...
    local specs = {
        ...
        NeogitDiffAdd = { fg = c.ok, bg = c.window_bg },
        NeogitDiffAddCursor = { fg = c.ok, bg = c.window_bg },
        NeogitDiffAddHighlight = { fg = c.ok, bg = c.window_accent },
        NeogitDiffAddInline = { fg = c.black, bg = c.ok },
        NeogitDiffChange = { fg = c.warn, bg = c.window_bg },
        NeogitDiffChangeCursor = { fg = c.warn, bg = c.window_bg },
        NeogitDiffChangeHighlight = { fg = c.warn, bg = c.window_accent },
        NeogitDiffChangeInline = { fg = c.black, bg = c.warn },
        NeogitDiffContext = { fg = c.ok, bg = c.window_bg },
        NeogitDiffContextCursor = { fg = c.ok, bg = c.window_bg },
        NeogitDiffContextHighlight = { fg = c.ok, bg = c.window_accent },
        NeogitDiffDelete = { fg = c.error, bg = c.window_bg },
        NeogitDiffDeleteCursor = { fg = c.error, bg = c.window_bg },
        NeogitDiffDeleteHighlight = { fg = c.error, bg = c.window_accent },
        NeogitDiffDeleteInline = { fg = c.black, bg = c.error },
        NeogitFold = { fg = c.redundant },
        NeogitHead = { fg = c.keyword },
        NeogitHunkHeader = { fg = c.fg, bg = c.window_bg },
        NeogitHunkHeaderCursor = { fg = c.fg, bg = c.window_bg },
        NeogitHunkHeaderHighlight = { fg = c.fg, bg = c.window_accent },
